...
DWORD ITESetEinkMinPenWidth(DWORD dwMinW, DWORD dwWidth, DWORD dwOffset, DWORD deOffsetY);//最小笔宽，笔宽。两个值如果十分接近，压感就会没有效果
...
DWORD ITESetEinkEraserWidth(DWORD dwMinW, DWORD dwWidth, DWORD dwOffX, DWORD dwOffY);//最小笔宽，笔宽。两个值如果十分接近，压感就会没有效果
