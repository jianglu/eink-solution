...
extern "C"
{
	...
	ITETCON_API BOOL IT8951LdImgArea(HANDLE hDevice, DWORD imageBuffer, DWORD x, DWORD y, DWORD width, DWORD height, BYTE* pSrcImg, DWORD sendBytes);
	...
	//??	0	300	7680	3296	0x0001	0x0001
	//??	3308	3840	404	160	0x0001	0x0001
	//??	3208	4000	604	160	0x0001	0x0001
	//??	3108	4160	804	160	0x0001	0x0001
